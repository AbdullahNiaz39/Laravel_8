                   ...
                   <table class="table">
                     ...
                     <tbody>
                       ...
                       <tr id="cart_box_{{$data->attr_id}}">
                         ...
                         onclick="deleteCartProduct('{{$data->pid}}','{{$data->size}}','{{$data->color}}',
                        '{{$data->attr_id}}',)"><fa class="fa fa-close"></fa></a></td>
                         <td><a href="{{url('product/'.$data->slug)}}"><img src="{{asset('admin_assets/images/'.$data->image)}}" width="60px" alt="img"></a></td>
                        ...
                        <br>COLOR:{{$data->color}}
                         ...
                         <td>Rs {{$data->price}}</td>
                         <td><input class="aa-cart-quantity" id="qty{{$data->attr_id}}" type="number" value="{{$data->qty}}"
                     ...
                     @endforeach
                       ...
                       <tr>
                         <td colspan="6" class="aa-cart-view-bottom">
                            <a class="aa-cart-view-btn" href="{{url('checkout')}}">
                             CheckOut</a>
