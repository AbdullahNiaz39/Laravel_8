...
function add_to_cart(id, size_str_id, color_str_id) {
    ...
    if (size_id == '' && size_id != 'no') {
        jQuery('#add_to_cart_msg').html('<div class="sufee-alert alert with-close alert-danger alert-dismissible fade-show"><button type = "button" class = "close" data-dismiss = "alert" aria-label ="close" ><span aria-hidden ="true" >x</span> </button>Please Select Size </div>');

    } else if (color_id == '' && color_id != 'no') {
        jQuery('#add_to_cart_msg').html('<div class="sufee-alert alert with-close alert-danger alert-dismissible fade-show"><button type = "button" class = "close" data-dismiss = "alert" aria-label = "close" ><span aria-hidden = "true" >x</span></button>Please Select color </div>');
    } else {
                ...
                if (result.msg = 'not_avaliable') {
                    ...
                    if (result.totalItem == 0) {
                        ...
                        jQuery.each(result.data, function(arrKey, arrVal) {
                            ...
                            html += '<li><a class="aa-cartbox-img" href="#"><img src="' + PRODUCT_IMAGE + '/' + arrVal.image + '" alt="img"></a><divclass="aa-cartbox-info"><h4><a href="#">' + arrVal.name + '</a></h4><p>' + arrVal.qty + ' * Rs ' + arrVal.price + '</p></div></li>';
                        });
